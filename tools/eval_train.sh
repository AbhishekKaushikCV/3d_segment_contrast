...
python3 inference_vis.py --dataset-name SemanticKITTI --log-dir /workspace/semseg_0p5/ --data-dir /workspace/dataset/SemanticKITTI/ --sparse-model MinkUNet --sparse-resolution 0.05 --batch-size 1 --checkpoint segment_contrast_0p5 --use-cuda --best epoch19 --use-intensity & wait;\
