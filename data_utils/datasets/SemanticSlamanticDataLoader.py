...
class SemanticSlamanticDataLoader(Dataset):
    def __init__(self, root,  split='test', pre_training=True, resolution=0.05, percentage=None, intensity_channel=False):
        self.root = root
        ...
        self.seq_ids = {}
        self.seq_ids['train'] = [ '20']
        self.seq_ids['validation'] = ['21']
        self.seq_ids['test'] = ['01']
    ...
    def datapath_list(self, split):
        ...
        if split == 'test':
            for seq in self.seq_ids[split]:
                point_seq_path = os.path.join(self.root, 'sequences', seq, 'velodyne')
            ...
            for seq in self.seq_ids[split]:
                ...
                try:
                    label_seq_path = os.path.join(self.root, 'sequences', seq, 'labels')
